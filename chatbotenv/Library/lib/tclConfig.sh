...
# installed.
TCL_PREFIX='K:/AL_ML Projects/Gen AI Krish Naik/Chatbot Sec-29/chatbotenv\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='K:/AL_ML Projects/Gen AI Krish Naik/Chatbot Sec-29/chatbotenv\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='K:/AL_ML Projects/Gen AI Krish Naik/Chatbot Sec-29/chatbotenv\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-IK:/AL_ML Projects/Gen AI Krish Naik/Chatbot Sec-29/chatbotenv\Library\include'
...
TCL_PACKAGE_PATH='K:/AL_ML Projects/Gen AI Krish Naik/Chatbot Sec-29/chatbotenv\Library\lib'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LK:/AL_ML Projects/Gen AI Krish Naik/Chatbot Sec-29/chatbotenv\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='K:/AL_ML Projects/Gen AI Krish Naik/Chatbot Sec-29/chatbotenv\Library\lib\tclstub86.lib'
